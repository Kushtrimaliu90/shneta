...
export async function FreeShippingProgress({
  ...
  return (
    <div className="rounded-md bg-forest-50 p-3">
      ...
      <progress
        ...
        max={thresholdCents}
        className="mt-2 h-1.5 w-full [&::-webkit-progress-bar]:rounded-full [&::-webkit-progress-bar]:bg-forest-100 [&::-webkit-progress-value]:rounded-full [&::-webkit-progress-value]:bg-lime-500"
      >
