...
2. **Hero** (banner `home_hero`): Space Grotesk headline (e.g. "Shëndeti yt, i thjeshtuar." / "Your health, simplified."), subline, primary CTA → `/shop`, secondary → `/finder`; product visual right; vitality ring draw-in.
